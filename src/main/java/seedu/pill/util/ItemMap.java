    ...
    public void listItemsToRestock(int threshold){
        try {
            ...
            if (filteredItems.isEmpty()) {
                LOGGER.info(String.format("There are no items that have quantity less than or equal to %d.", threshold));
                System.out.printf("There are no items that have quantity less than or equal to %d:%n", threshold);

            } else {
                LOGGER.info(String.format("Listing all items that need too be restocked (less than or equal to %d):", threshold));
                System.out.printf("Listing all items that need too be restocked (less than or equal to %d):%n", threshold);
